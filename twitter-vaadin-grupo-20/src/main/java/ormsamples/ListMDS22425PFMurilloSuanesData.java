...
import org.orm.*;
public class ListMDS22425PFMurilloSuanesData {
	...
	public void listTestData() throws PersistentException {
		...
		int length = Math.min(basededatosDocumentos.length, ROW_COUNT);
		...
		basededatos.PropiedadesBaneo[] basededatosPropiedadesBaneos = basededatos.PropiedadesBaneoDAO.listPropiedadesBaneoByQuery(null, null);
		...
		basededatos.Usuario_Autentificado[] basededatosUsuario_Autentificados = basededatos.Usuario_AutentificadoDAO.listUsuario_AutentificadoByQuery(null, null);
		length = Math.min(basededatosUsuario_Autentificados.length, ROW_COUNT);
		for (int i = 0; i < length; i++) {
		...
		basededatos.PropiedadesSeguidos[] basededatosPropiedadesSeguidoses = basededatos.PropiedadesSeguidosDAO.listPropiedadesSeguidosByQuery(null, null);
		...
		basededatos.PropiedadesMencion[] basededatosPropiedadesMencions = basededatos.PropiedadesMencionDAO.listPropiedadesMencionByQuery(null, null);
	...
	public void listByCriteria() throws PersistentException {
		...
		int length =basededatosDocumentos== null ? 0 : Math.min(basededatosDocumentos.length, ROW_COUNT); 
		for (int i = 0; i < length; i++) {
			 System.out.println(basededatosDocumentos[i]);
		}
		...
		basededatos.PropiedadesBaneo[] basededatosPropiedadesBaneos = lbasededatosPropiedadesBaneoCriteria.listPropiedadesBaneo();
		...
		basededatos.Usuario_Autentificado[] basededatosUsuario_Autentificados = lbasededatosUsuario_AutentificadoCriteria.listUsuario_Autentificado();
		length =basededatosUsuario_Autentificados== null ? 0 : Math.min(basededatosUsuario_Autentificados.length, ROW_COUNT); 
		for (int i = 0; i < length; i++) {
			 System.out.println(basededatosUsuario_Autentificados[i]);
		}
		...
		basededatos.PropiedadesSeguidos[] basededatosPropiedadesSeguidoses = lbasededatosPropiedadesSeguidosCriteria.listPropiedadesSeguidos();
		length =basededatosPropiedadesSeguidoses== null ? 0 : Math.min(basededatosPropiedadesSeguidoses.length, ROW_COUNT); 
		for (int i = 0; i < length; i++) {
			 System.out.println(basededatosPropiedadesSeguidoses[i]);
		}
		...
		basededatos.PropiedadesMencion[] basededatosPropiedadesMencions = lbasededatosPropiedadesMencionCriteria.listPropiedadesMencion();
		length =basededatosPropiedadesMencions== null ? 0 : Math.min(basededatosPropiedadesMencions.length, ROW_COUNT); 
		for (int i = 0; i < length; i++) {
			 System.out.println(basededatosPropiedadesMencions[i]);
		}
	...
	public static void main(String[] args) {
		try {
			ListMDS22425PFMurilloSuanesData listMDS22425PFMurilloSuanesData = new ListMDS22425PFMurilloSuanesData();
			try {
				listMDS22425PFMurilloSuanesData.listTestData();
				//listMDS22425PFMurilloSuanesData.listByCriteria();
			}
			finally {
