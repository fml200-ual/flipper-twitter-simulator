...
public class MDS22425PFMurilloSuanesPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS22425PFMurilloSuanes";
	...
	private MDS22425PFMurilloSuanesPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS22425PFMurilloSuanesPersistentManager();
		}
