...
public class Usuario_Registrado extends basededatos.Usuario_Autentificado implements Serializable {
	...
	@JoinTable(name = "Comentario_Usuario_Registrado2", joinColumns = {
			@JoinColumn(name = "Usuario_RegistradoUsuario_AutentificadoId_usuario") }, inverseJoinColumns = {
					@JoinColumn(name = "ComentarioId_comentario") })
	...
	@org.hibernate.annotations.Cascade({ org.hibernate.annotations.CascadeType.SAVE_UPDATE,
			org.hibernate.annotations.CascadeType.LOCK })
	@JoinTable(name = "Tweet_Usuario_Registrado2", joinColumns = {
			@JoinColumn(name = "Usuario_RegistradoUsuario_AutentificadoId_usuario") }, inverseJoinColumns = {
					@JoinColumn(name = "TweetId_tweet") })
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)
	...
	@org.hibernate.annotations.Cascade({ org.hibernate.annotations.CascadeType.SAVE_UPDATE,
			org.hibernate.annotations.CascadeType.LOCK })
	@JoinTable(name = "Usuario_Registrado_Usuario_Registrado2", joinColumns = {
			@JoinColumn(name = "Usuario_RegistradoUsuario_AutentificadoId_usuario2") }, inverseJoinColumns = {
					@JoinColumn(name = "Usuario_RegistradoUsuario_AutentificadoId_usuario") })
	@org.hibernate.annotations.LazyCollection(org.hibernate.annotations.LazyCollectionOption.TRUE)
	...
	@Transient
	public final basededatos.ComentarioSetCollection me_gusta_Comentarios = new basededatos.ComentarioSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_ME_GUSTA_COMENTARIOS,
			ORMConstants.KEY_COMENTARIO_RECIBE_ME_GUSTA, ORMConstants.KEY_MUL_MANY_TO_MANY);
	...
	@Transient
	public final basededatos.TweetSetCollection tweets = new basededatos.TweetSetCollection(this, _ormAdapter,
			ORMConstants.KEY_USUARIO_REGISTRADO_TWEETS, ORMConstants.KEY_TWEET_PUBLICADO_POR,
	...
	@Transient
	public final basededatos.ComentarioSetCollection comentarios_publicados = new basededatos.ComentarioSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_COMENTARIOS_PUBLICADOS,
			ORMConstants.KEY_COMENTARIO_PUBLICADO_POR, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	public final basededatos.PropiedadesMencionSetCollection propiedadesMencions = new basededatos.PropiedadesMencionSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_PROPIEDADESMENCIONS,
			ORMConstants.KEY_PROPIEDADESMENCION_USUARIO_REGISTRADO, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	public final basededatos.RetweetSetCollection retweets = new basededatos.RetweetSetCollection(this, _ormAdapter,
			ORMConstants.KEY_USUARIO_REGISTRADO_RETWEETS, ORMConstants.KEY_RETWEET_USUARIO_REGISTRADO,
			ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient
	public final basededatos.TweetSetCollection me_gusta_tweets = new basededatos.TweetSetCollection(this, _ormAdapter,
			ORMConstants.KEY_USUARIO_REGISTRADO_ME_GUSTA_TWEETS, ORMConstants.KEY_TWEET_RECIBE_ME_GUSTA,
	...
	public void removeSeguidoresUsuario_registrado(basededatos.Usuario_Registrado aSeguidoresUsuario_registrado) {
		...
		for (int i = 0; i < lSeguidoresPropiedadesseguidoss.length; i++) {
			if (lSeguidoresPropiedadesseguidoss[i].getSeguidoresUsuario_registrado()
					.equals(aSeguidoresUsuario_registrado)) {
				seguidoresPropiedadesseguidoss.remove(lSeguidoresPropiedadesseguidoss[i]);
			}
		}
	}

	public void addSeguidoresUsuario_registrado(basededatos.PropiedadesSeguidos aPropiedadesSeguidos,
			basededatos.Usuario_Registrado aSeguidoresUsuario_registrado) {
	...
	public basededatos.PropiedadesSeguidos getPropiedadesSeguidosBySeguidoresUsuario_registrado(
			basededatos.Usuario_Registrado aSeguidoresUsuario_registrado) {
		basededatos.PropiedadesSeguidos[] lSeguidoresPropiedadesseguidoss = seguidoresPropiedadesseguidoss.toArray();
		for (int i = 0; i < lSeguidoresPropiedadesseguidoss.length; i++) {
			if (lSeguidoresPropiedadesseguidoss[i].getSeguidoresUsuario_registrado()
	...
	@Transient
	public final basededatos.PropiedadesSeguidosSetCollection seguidoresPropiedadesseguidoss = new basededatos.PropiedadesSeguidosSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_SEGUIDORESPROPIEDADESSEGUIDOSS,
	...
	public void addAdministrador(basededatos.PropiedadesBaneo aPropiedadesBaneo,
			basededatos.Administrador aAdministrador) {
	...
	@Transient
	public final basededatos.Usuario_RegistradoSetCollection meTienenBloqueado = new basededatos.Usuario_RegistradoSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_METIENENBLOQUEADO,
			ORMConstants.KEY_USUARIO_REGISTRADO_BLOQUEADOS, ORMConstants.KEY_MUL_MANY_TO_MANY);
	...
	public void addSeguidosUsuario_registrado(basededatos.PropiedadesSeguidos aPropiedadesSeguidos,
			basededatos.Usuario_Registrado aSeguidosUsuario_registrado) {
	...
	public basededatos.PropiedadesSeguidos getPropiedadesSeguidosBySeguidosUsuario_registrado(
			basededatos.Usuario_Registrado aSeguidosUsuario_registrado) {
		basededatos.PropiedadesSeguidos[] lSeguidosPropiedadesseguidoss = seguidosPropiedadesseguidoss.toArray();
		for (int i = 0; i < lSeguidosPropiedadesseguidoss.length; i++) {
			if (lSeguidosPropiedadesseguidoss[i].getSeguidosUsuario_registrado().equals(aSeguidosUsuario_registrado)) {
	...
	@Transient
	public final basededatos.PropiedadesSeguidosSetCollection seguidosPropiedadesseguidoss = new basededatos.PropiedadesSeguidosSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_SEGUIDOSPROPIEDADESSEGUIDOSS,
			ORMConstants.KEY_PROPIEDADESSEGUIDOS_SEGUIDORESUSUARIO_REGISTRADO, ORMConstants.KEY_MUL_ONE_TO_MANY);
	...
	@Transient
	public final basededatos.Usuario_RegistradoSetCollection bloqueados = new basededatos.Usuario_RegistradoSetCollection(
			this, _ormAdapter, ORMConstants.KEY_USUARIO_REGISTRADO_BLOQUEADOS,
			ORMConstants.KEY_USUARIO_REGISTRADO_METIENENBLOQUEADO, ORMConstants.KEY_MUL_MANY_TO_MANY);
