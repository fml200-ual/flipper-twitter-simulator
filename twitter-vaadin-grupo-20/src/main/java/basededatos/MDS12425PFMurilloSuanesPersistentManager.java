...
/**
 * Licensee: Ángel(University of Almeria)
...
public class MDS12425PFMurilloSuanesPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MDS12425PFMurilloSuanes";
	...
	private MDS12425PFMurilloSuanesPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MDS12425PFMurilloSuanesPersistentManager();
		}
