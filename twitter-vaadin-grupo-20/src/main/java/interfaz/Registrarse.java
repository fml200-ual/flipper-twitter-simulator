...
public class Registrarse extends VistaRegistrarse {
	...
	public IniciarsesinconGoogle _iniciarsesinconGoogle;	public Registrarse(ACT01UsuarioNoRegistrado _aCT01UsuarioNoRegistrado) {
		super();
	...
	private void goBack() {
		if (_aCT01UsuarioNoRegistrado != null) {
			// Solo limpiar el layout central para volver a la vista original
			_aCT01UsuarioNoRegistrado.getVerticalLayoutCentralNoRegistrado().as(com.vaadin.flow.component.orderedlayout.VerticalLayout.class).removeAll();
		} else if (_iniciarsesin != null) {
			// Volver a la vista de iniciar sesión
			_iniciarsesin._aCT01UsuarioNoRegistrado.getVerticalLayoutCentralNoRegistrado().as(com.vaadin.flow.component.orderedlayout.VerticalLayout.class).removeAll();
			_iniciarsesin._aCT01UsuarioNoRegistrado.getVerticalLayoutCentralNoRegistrado().as(com.vaadin.flow.component.orderedlayout.VerticalLayout.class).add(_iniciarsesin);
		}
	}
	...
	public void Introducircdigodeverificacin() {
		...
		if (_aCT01UsuarioNoRegistrado != null) {
			...
			_aCT01UsuarioNoRegistrado.getVerticalLayoutCentralNoRegistrado()
				.as(com.vaadin.flow.component.orderedlayout.VerticalLayout.class).add(_introducircdigodeverificacin);
		} else if (_iniciarsesin != null) {
