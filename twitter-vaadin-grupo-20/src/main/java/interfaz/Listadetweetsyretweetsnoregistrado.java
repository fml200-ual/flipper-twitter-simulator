...
public class Listadetweetsyretweetsnoregistrado extends Listadetweetsyretweets {
	...
	private void setupTweetData(Listadetweetsyretweetsnoregistrado_item tweetItem, String username, String content,
			String time) {
	...
	private void setupTweetClickability(Listadetweetsyretweetsnoregistrado_item tweetItem, String username,
			String content) {
	...
	private void navigateToTweetDetail(String username, String content) {
		...
		if (_verhashtagnoregistrado != null) {
			...
			Pantalla.MainView.add(vistaDetalleTweet);
		}
	}
}