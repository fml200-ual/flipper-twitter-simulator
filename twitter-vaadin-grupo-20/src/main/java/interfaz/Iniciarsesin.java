...
public class Iniciarsesin extends VistaIniciarsesin{
	...
	public ACT04SistemadeCorreo _aCT04SistemadeCorreo;	public Iniciarsesin(ACT01UsuarioNoRegistrado _aCT01UsuarioNoRegistrado) {
		super();
	...
	public void Registrarse() {
		// Este método ya no se usa directamente, la navegación se hace en navegarARegistro()
		navegarARegistro();
	}

	public void IniciarsesinconGoogle() {
		// Aquí iría la lógica de autenticación con Google
		System.out.println("Iniciando sesión con Google...");
